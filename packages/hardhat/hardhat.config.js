...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/f725bf28c5ee4dd4aa2de5437af52eb8", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/f725bf28c5ee4dd4aa2de5437af52eb8", // <---- YOUR INFURA ID! (or it won't work)
...
task(
  ...
  async (_, { ethers }) => {
    ...
    qrcode.generate(wallet._privKey.toString("hex"), { small: true});
