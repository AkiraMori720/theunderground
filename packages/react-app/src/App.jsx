  ...
  */
  ...
  if (NETWORKCHECK && localChainId && selectedChainId && localChainId !== selectedChainId) {
    ...
    if (selectedChainId === 1337 && localChainId === 31337) {
      networkDisplay = (
        <div style={{ zIndex: 10000, position: "fixed", right: 0, top: 60, padding: 16 }}>
          <Alert
  ...
  useEffect(() => {
    if (objCanMintCount != undefined) {
      setMintCount(parseInt(objCanMintCount["_hex"]));
    }
    if (DEBUG) console.log(
      "~~~~~~~~~~~~~~~~~~~~~~~ remain mint " + objCanMintCount + "@" + remainMintCount
    );
  }, [objCanMintCount]);
